...
const adapterNumber = (num,percent)=> {
  return num * percent;
}

let Num = function(xPer,yPer){  
  this.xPer = xPer;
  this.yPer = yPer;
}

Num.of = function(xPer,yPer){
  return new Num(xPer,yPer);
}

Num.prototype.getX = function(value){
  return Math.floor(this.xPer*value);
}

Num.prototype.getY = function(value){
  // return value;
  return Math.floor(this.yPer*value);
}

Num.prototype.get = function(value) {
  return Math.floor(value*this.xPer);
}
...
const type4numbers = [
  ...
  [1,0,10,5,9,4,8,15,14,13,6,3,2,7,11,12],
  [10,8,15,1,14,9,4,5,13,6,11,0,2,7,12,3],
  [10,4,8,2,14,12,9,15,13,7,11,0,3,6,5,1]
]
